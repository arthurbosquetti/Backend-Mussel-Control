...
ADAFRUIT_IO_FEEDNAME6 = b'P (PID)'               # publish
ADAFRUIT_IO_FEEDNAME7 = b'I (PID)'               # publish
ADAFRUIT_IO_FEEDNAME8 = b'D (PID)'               # publish
...
data_file.write("Temperature, Algae Concentration, P, I, D \n")
data_file.close() 

while True:

    oled.printWiFiStatus(IOManager.wifi.isconnected())
    P, I, D = pid.PID_once(K_p, K_i, K_d)
